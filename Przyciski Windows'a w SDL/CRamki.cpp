...
bool CRamki::laduj_ramki( SDL_Surface* ekran_glowny )
{
    m_checkbox[0] = CRamki::load_image( m_adresGrafik + "/check_box/check_null_out.png" );
    if( m_checkbox[0] == NULL ) { return false; }
	...
	m_checkbox[6] = CRamki::load_image( m_adresGrafik + "/check_box/check_disabled.png" );
    if( m_checkbox[6] == NULL ) { return false; }
	m_checkbox[7] = CRamki::load_image( m_adresGrafik + "/check_box/check_tick_disabled.png" );
    if( m_checkbox[7] == NULL ) { return false; }
    
    
    m_button_std[0] = CRamki::load_image( m_adresGrafik + "/button_std/unactive_left.png" );
    if( m_button_std[0] == NULL ) { return false; }
	...
	m_button_std[9] = CRamki::load_image( m_adresGrafik + "/button_std/disabled_left.png" );
    if( m_button_std[9] == NULL ) { return false; }
	m_button_std[10] = CRamki::load_image( m_adresGrafik + "/button_std/disabled_center.png" );
    if( m_button_std[10] == NULL ) { return false; }
	m_button_std[11] = CRamki::load_image( m_adresGrafik + "/button_std/disabled_right.png" );
    if( m_button_std[11] == NULL ) { return false; }
    
    
    m_radiobutton[0] = CRamki::load_image( m_adresGrafik + "/radio_button/null_unactive.png" );
    if( m_radiobutton[0] == NULL ) { return false; }
	...
	m_radiobutton[6] = CRamki::load_image( m_adresGrafik + "/radio_button/null_disabled.png" );
    if( m_radiobutton[6] == NULL ) { return false; }
	m_radiobutton[7] = CRamki::load_image( m_adresGrafik + "/radio_button/tick_disabled.png" );
    if( m_radiobutton[7] == NULL ) { return false; }
    
    
    m_border_std[0] = CRamki::load_image( m_adresGrafik + "/border/unactive_left_top.png" );
    if( m_border_std[0] == NULL ) { return false; }
    ...
    m_border_std[24] = CRamki::load_image( m_adresGrafik + "/border/disabled_left_top.png" );
    if( m_border_std[24] == NULL ) { return false; }
    m_border_std[25] = CRamki::load_image( m_adresGrafik + "/border/disabled_top.png" );
    if( m_border_std[25] == NULL ) { return false; }
    m_border_std[26] = CRamki::load_image( m_adresGrafik + "/border/disabled_right_top.png" );
    if( m_border_std[26] == NULL ) { return false; }
    m_border_std[27] = CRamki::load_image( m_adresGrafik + "/border/disabled_left.png" );
    if( m_border_std[27] == NULL ) { return false; }
    m_border_std[28] = CRamki::load_image( m_adresGrafik + "/border/disabled_right.png" );
    if( m_border_std[28] == NULL ) { return false; }
    m_border_std[29] = CRamki::load_image( m_adresGrafik + "/border/disabled_left_bottom.png" );
    if( m_border_std[29] == NULL ) { return false; }
    m_border_std[30] = CRamki::load_image( m_adresGrafik + "/border/disabled_bottom.png" );
    if( m_border_std[30] == NULL ) { return false; }
    m_border_std[31] = CRamki::load_image( m_adresGrafik + "/border/disabled_right_bottom.png" );
    if( m_border_std[31] == NULL ) { return false; }
    
    
    
    m_border2[0] = CRamki::load_image( m_adresGrafik + "/border2/left_top.png" );
    if( m_border2[0] == NULL ) { return false; }
    ...
    m_combobox[0] = CRamki::load_image( m_adresGrafik + "/combo_box/unactive_arrow.png" );
    if( m_combobox[0] == NULL ) { return false; }
    m_combobox[1] = CRamki::load_image( m_adresGrafik + "/combo_box/mouse_arrow.png" );
    if( m_combobox[1] == NULL ) { return false; }
    m_combobox[2] = CRamki::load_image( m_adresGrafik + "/combo_box/clicked_arrow.png" );
    if( m_combobox[2] == NULL ) { return false; }
    m_combobox[3] = CRamki::load_image( m_adresGrafik + "/combo_box/disabled_arrow.png" );
    if( m_combobox[3] == NULL ) { return false; }
    
    m_screen = ekran_glowny;
