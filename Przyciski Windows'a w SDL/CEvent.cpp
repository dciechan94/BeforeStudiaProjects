...
//==============================================================================
void CEvent::apply_surface(int x, int y, SDL_Surface *source, SDL_Surface *destination)
{
    SDL_Rect offset;
...
void CEvent::apply_surface(int x, int y, SDL_Surface *source, SDL_Surface *destination, SDL_Rect* rect)
{
    SDL_Rect offset;
